 ...
 *
 * HadoopJarStepConfig config = new PigStep()
...
public class PigStep {
   ...
   *         together.
   */
  public PigStep withInputs(String ... inputs) {
   ...
   *         together.
   */
  public PigStep withOutput(String output) {
    this.output = output;
    return this;
  }
   ...
   *         together.
   */
  public PigStep withScript(String script) {
    this.script = script;
    return this;
  }
   ...
   *         together.
   */
  public PigStep withNumMapTasks(String numMapTasks) {
    this.numMapTasks = numMapTasks;
    return this;
  }
   ...
   *         together.
   */
  public PigStep withNumReduceTasks(String numReduceTasks) {
    this.numReduceTasks = numReduceTasks;
    return this;
  }
   ...
   *         together.
   */
  public PigStep withHadoopConfig(String key, String value) {
