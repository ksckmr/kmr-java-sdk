...
public class ListInstanceGroupsRequestMarshaller
        implements
        Marshaller<RequestMessage<ListInstanceGroupsRequest>, ListInstanceGroupsRequest> {

    public RequestMessage<ListInstanceGroupsRequest> marshall(
        ...
        RequestMessage<ListInstanceGroupsRequest> request = new RequestMessage<ListInstanceGroupsRequest>();
        request.addHeader(HttpHeaders.REQUEST_TARGET, "ElasticMapReduce_V1.ListInstanceGroups");
