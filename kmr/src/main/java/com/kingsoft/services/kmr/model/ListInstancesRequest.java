 ...
 * </p>
 */
public class ListInstancesRequest extends RequestMessage implements
    ...
    public java.util.List<String> getInstanceGroupTypes() {
        if (instanceGroupTypes == null) {
            instanceGroupTypes = new ArrayList<String>();
        }
    ...
    public void setInstanceGroupTypes(
        ...
        this.instanceGroupTypes = new ArrayList<String>(
                instanceGroupTypes);
    }
    ...
    public ListInstancesRequest withInstanceGroupTypes(
        ...
        if (this.instanceGroupTypes == null) {
            setInstanceGroupTypes(new ArrayList<String>(
    ...
    public ListInstancesRequest withInstanceGroupTypes(
        ...
        List<String> instanceGroupTypesCopy = new ArrayList<String>(
                instanceGroupTypes.length);
