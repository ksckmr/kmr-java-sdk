 ...
 * </p>
 */
public class ListStepsRequest extends RequestMessage implements
    ...
    public java.util.List<String> getStepStates() {
        if (stepStates == null) {
            stepStates = new ArrayList<String>();
        }
        return stepStates;
    }
    ...
    public void setStepStates(java.util.Collection<String> stepStates) {
        ...
        this.stepStates = new ArrayList<String>(
                stepStates);
    }
    ...
    public ListStepsRequest withStepStates(String... stepStates) {
        if (this.stepStates == null) {
            setStepStates(new ArrayList<String>(
                    stepStates.length));
        }
    ...
    public ListStepsRequest withStepStates(StepState... stepStates) {
        List<String> stepStatesCopy = new ArrayList<String>(
                stepStates.length);
